...
/**
* all_helper - Displays all possible builtin sh commands.
*/
void all_helper(void)
{
...
/**
* alias_helper - Displays information on the sh builtin command 'alias'.
*/
void alias_helper(void)
{
...
/**
* cd_helper - Displays information on the sh builtin command 'cd'.
*/
void cd_helper(void)
{
...
/**
* exit_helper - Displays information on the sh builtin command 'exit'.
*/
void exit_helper(void)
{
...
/**
* help_helper - Displays information on the sh builtin command 'help'.
*/
void help_helper(void)
{
char *msg = "help: help\n\tSee all possible sh builtin commands.\n";
