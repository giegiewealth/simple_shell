...
/**
* err_1 - Creates an error message for sh_alias errors.
* @args: An array of arguments passed to the command.
*
* Return: The error string.
*/
...
/**
* err_2_exit - Creates an error message for sh_exit errors.
* @args: An array of arguments passed to the command.
*
* Return: The error string.
*/
...
/**
* err_2_cd - Creates an error message for sh_cd errors.
* @args: An array of arguments passed to the command.
*
* Return: The error string.
*/
...
/**
* err_2_sntx - Creates an error message for syntax errors.
* @args: An array of arguments passed to the command.
*
* Return: The error string.
*/
